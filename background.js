...
//   let currentVideoPlayBackSpeed = 0;
...
//       },
//       (url) => {
//         if (url && url[0] && url[0].result) {
//           currentVideoPlayBackSpeed = url[0].result;
//         } else {
//           currentVideoPlayBackSpeed = -1;
//         }
//         resolve();
//       }
//     );
//   });
//   await promise;
//   return currentVideoPlayBackSpeed;
// }

// const setExtensionIcon = async (tabId, currentPlayBackSpeed) => {
//   let isEnabled = false;
...
//     isEnabled = true;
//   } else {
//     chrome.action.setIcon({ tabId, path: 'images/online-video_128.png' });
//   }
//   return isEnabled;
// };
